                ...
                <div class="col-sm-6 left-side">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input id="cityInput" class="form-control" name="city" value="<?= $default_city ?>" type="text" placeholder="<?= lang('city') ?>" readonly>
                        </div>
                        ...
                        <div class="form-group col-sm-12">
                            <label for="notesInput"><?= lang('notes') ?>/NOTE: Please include change for if will not pay the exact amount</label>
